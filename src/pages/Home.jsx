function Home(){
    return(
         <div className="bg-gradient-to-r from-white to-blue-200 min-h-screen flex flex-col justify-around align-middle sm:flex-col md:flex-col lg:flex-row">
            ...
            <div className="my-auto w-full h-full shadow-2xl sm:flex-col ">
